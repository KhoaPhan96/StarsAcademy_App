...
{
    public partial class frm_StartAcademy : Form
    {
        #region Variables     
       ...
       // private string api_Key = "37741d319ba8deb7";
        ...
        #region public frm_StartAcademy()
        public frm_StartAcademy()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private async void accordionControlElement_danhSach_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt_API_XML = await Models.DanhSachBaiGiang_Show.GetDanhSach_NotExists_API(ApiUrl, api_Key, path);
        ...
        private async void accordionControlElement_danhSachDaTai_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                #region Hiển thị lên lưới
                dt_DanhSachDaTai = Models.DanhSachBaiGiang_Show.GetDanhSachDaTai(path_XML, api_Key);
                gridControl1.DataSource = dt_DanhSachDaTai;
                tileView1.Columns["Image_Lession_Show"].ColumnEdit = repositoryItemPictureEdit;
        ...
        private void textEdit_Search_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (type == 0)
                {
                    filteredRows = dt_API_XML.Select(filterExpression);

                    dt_filter = dt_API_XML.Clone();                                     
                }
                else
                {
